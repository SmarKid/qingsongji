...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">本周消费</h4>
                                <div class="text-right">
                                    <h2 class="font-light m-b-0"><i class="ti-arrow-up text-success"></i> ￥${weeksum }</h2>
                                    <!--<span class="text-muted">Todays Income</span>-->
                                </div>
                                <span class="text-success">${weekratio }%</span>
                                <div class="progress">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: ${weekratio }%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-sm-6">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">本月消费</h4>
                                <div class="text-right">
                                    <h2 class="font-light m-b-0"><i class="ti-arrow-up text-success"></i> ￥${monthsum }</h2>
                                    <!--<span class="text-muted">Todays Income</span>-->
                                </div>
                                <span class="text-success">${monthratio }%</span>
                                <div class="progress">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: ${monthratio }%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
				...
				<div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">${nearBudNam1 }</h4>
                                <div class="text-right">
                                    <h2 class="font-light m-b-0"><i class="ti-arrow-up text-info"></i> ￥${diffamount}</h2>
                                </div>
                                <span class="text-info">${diffratio }%</span>
                                <div class="progress">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: ${diffratio}%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">${nearBudNam2 }</h4>
                                <div class="text-right">
                                    <h2 class="font-light m-b-0"><i class="ti-arrow-up text-info"></i>  ${diffdate }天</h2>
                                </div>
                                <span class="text-info">${diffdateratio }%</span>
                                <div class="progress">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: ${diffdateratio}%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="res/assets/plugins/flot/jquery.flot.js"></script>
    <script src="res/assets/plugins/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
    <script src="res/js/flot-data.js"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
