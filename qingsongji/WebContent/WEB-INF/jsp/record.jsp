                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">收支记录</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive">
                                    <table class="col-lg-12 table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${ expenseModelArray }" var="i">
											   <tr>
	                                                <td><c:out value="${i.date}"/></td>
	                                                <td><c:out value="${i.amount}"/></td>
	                                                <td><c:out value="${i.way}"/></td>
	                                                <td><c:out value="${i.usefor}"/></td>
	                                                <td><c:out value="${i.notes}"/></td>
	                                                <td>
	                                                	<!-- <a href="budget.jsp" class="waves-effect"><i class="fa fa-pencil-square m-r-10" aria-hidden="true"></i>修改</a>/ -->
	                                                	<a href="deleteexpense?id=${i.id }" class="waves-effect"><i class="fa fa-times m-r-10" aria-hidden="true"></i>删除</a>
	                                                </td>
	                                            </tr><p>
											</c:forEach>
                                        </tbody>
                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive">
                                    <table class="col-lg-12 table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${ incomeModelArray }" var="j">
											   <tr>
	                                                <td><c:out value="${j.date}"/></td>
	                                                <td><c:out value="${j.amount}"/></td>
	                                                <td><c:out value="${j.way}"/></td>
	                                                <td><c:out value="${j.source}"/></td>
	                                                <td><c:out value="${j.notes}"/></td>
	                                                <td>
	                                                	<!-- <a href="budget.jsp" class="waves-effect"><i class="fa fa-pencil-square m-r-10" aria-hidden="true"></i>修改</a>/ -->
	                                                	<a href="deleteincome?id=${j.id }" class="waves-effect"><i class="fa fa-times m-r-10" aria-hidden="true"></i>删除</a>
	                                                </td>
	                                            </tr><p>
											</c:forEach>
                                        </tbody>
